...
<div align="center">
  ...
  <!--
    GitHub only plays <video> tags when the src is a link generated by GitHub's
    own upload system (a "user-attachments" / "user-images" URL) — a relative
    repo path like docs/video/demo.mp4 will NEVER play inline, no matter how
    the tag is written. To fix this for real:

      1. Open this file for editing on github.com (or open any Issue/PR/comment box).
      2. Drag-and-drop demo.mp4 straight into the text box.
      3. GitHub uploads it and inserts a link that looks like:
         https://github.com/user-attachments/assets/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
      4. Replace the src="..." below with that link (keep the rest of the tag as is).

    Until you do that, the block below shows a clickable thumbnail as a safe
    fallback so the video is still reachable from the README.
  -->

  <a href="docs/video/demo.mp4">
    <img src="https://img.shields.io/badge/▶_WATCH_THE_DEMO-Click_to_play_video-FF6B35?style=for-the-badge" alt="Watch the demo video" />
  </a>

  <br /><br />
  <sub>Full walkthrough: home page → category browsing & filters → cart & wishlist → checkout & payment options.</sub>
  <br />
  <sub>(This badge links to the video file directly. For an inline auto-playing preview, upload the video through GitHub's editor as described in the comment above and swap in the generated link.)</sub>
