    ...
    <>
      <ul className="navbar-nav mx-auto">
        <li className="nav-item">
          <Link to="/" onClick={closeNavbar} className="nav-link active text-white" aria-current="page" style={{ fontSize: '0.9rem' }}>
            <FaHome size={20} className="me-1" /> Home
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/fashion" onClick={closeNavbar} className="nav-link text-white" style={{ fontSize: '0.9rem' }}>
            <FaTshirt size={20} className="me-1" /> Fashion
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/supermarket" onClick={closeNavbar} className="nav-link text-white" style={{ fontSize: '0.9rem' }}>
            <FaShoppingCart size={20} className="me-1" /> Supermarket
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/petcare" onClick={closeNavbar} className="nav-link text-white" style={{ fontSize: '0.9rem' }}>
            <FaPaw size={20} className="me-1" /> Pet Care Products
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/babycare" onClick={closeNavbar} className="nav-link text-white" style={{ fontSize: '0.9rem' }}>
            <FaBaby size={20} className="me-1" /> Baby Care Products
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/books" onClick={closeNavbar} className="nav-link text-white" style={{ fontSize: '0.9rem' }}>
            <FaBook size={20} className="me-1" /> Books
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/wishlist" onClick={closeNavbar} className="nav-link text-white" style={{ fontSize: '0.9rem' }}>
            <FaHeart style={{ marginRight: '5px' }} /> Wishlist
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/userprofile" onClick={closeNavbar} className="nav-link text-white" style={{ fontSize: '0.9rem' }}>
            User Profile
          </Link>
        </li>
      </ul>
      ...
      <div className="d-flex align-items-center">
        <Link to="/login" onClick={closeNavbar} className="btn btn-outline-light me-2" style={{ fontSize: '0.9rem' }}>
          <FaSignInAlt size={18} className="me-1" /> Login
        </Link>
        <Link to="/cart" onClick={closeNavbar} className="nav-link text-white">
          <BiCart size={20} />
